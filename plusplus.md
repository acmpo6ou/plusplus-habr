...
Я создал этот модуль для демонстрации гибкости python и техник манипуляции байт-кодом.
...
Дизассемблируем и собираем байт-код назад мы с помощью [вот этой](https://github.com/MatthieuDartiailh/bytecode) библиотеки.
